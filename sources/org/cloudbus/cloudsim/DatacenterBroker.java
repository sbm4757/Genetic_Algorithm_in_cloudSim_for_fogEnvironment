...
public class DatacenterBroker extends SimEntity {
	...
	public int[][] assignCloudletToVM(List<? extends Vm> vmlist,List<? extends Cloudlet> cloudletList, Datacenter datacenter2) throws Exception
	{
		...
		int newPopSize=200; //better to have a fixed value 100 or 20 pop size
	...
	private float calculatePower(int[][] a, List<? extends Vm> vmlist2, List<? extends Cloudlet> cloudletList2, Datacenter datacenter2) {
		// TODO Auto-generated method stub
		float beta=0.8f;
		float power=0.0f;
		float vt=0.0f;
